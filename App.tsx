...
${aiSection}
==========================================================
Generated by Polineuropathy-Assistant Electrodiagnóstico PMR Specialist Platform by Leo J Escobar.
`;
  ...
  const handleGeneratePDF = () => {
    ...
    // Headers with full 'Percentil' word
    const tableHeaders = [[
        lang === 'es' ? 'Nervio' : 'Nerve', 
        lang === 'es' ? 'Valor' : 'Val', 
        lang === 'es' ? 'Percentil' : 'Percentile', 
        lang === 'es' ? 'Pts' : 'Pts'
    ]];

    // Using slightly smaller font to accommodate the longer header word if needed
    autoTable(doc, {
        startY: startYScores + 2,
        head: tableHeaders,
        body: score2Rows,
        theme: 'striped',
        headStyles: { fillColor: [51, 65, 85], fontSize: 6.5, minCellHeight: 5, halign: 'center' },
        bodyStyles: { fontSize: 6.5, minCellHeight: 5, halign: 'center' },
    ...
    // Move footer slightly up to ensure it fits on page
    doc.text(`Generated by Polineuropathy-Assistant Electrodiagnóstico PMR by Leo J Escobar`, pageWidth / 2, 285, { align: "center" });
